...
list multi-device mode: ./ftdi-eeprom-config -V 0x403 -P 0x6010 -S 1234567 -! multi -@ 0
program multi-device: ./ftdi-eeprom-config -V 0x403 -P 0x6010 -S 1234567 -! multi -@ 0 -s New_1234
```
